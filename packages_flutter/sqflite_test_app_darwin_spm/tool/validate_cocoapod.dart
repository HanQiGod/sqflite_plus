...
Future<void> main() async {
  await disableSpm();
  var shell = Shell(workingDirectory: '../../sqflite_plus_darwin');
  await shell.run('''
...
pod lib lint darwin/sqflite_plus_darwin.podspec --configuration=Debug --skip-tests --use-modular-headers --allow-warnings
