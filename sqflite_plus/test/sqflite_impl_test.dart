...
import 'package:sqflite_plus/src/factory_impl.dart';
import 'package:sqflite_plus/src/mixin/factory.dart';
...
void main() {
  ...
  group('sqflite', () {
    const channel = MethodChannel('com.tekartik.sqflite_plus');
