...
* Linux/Windows/DartVM support using [sqflite_plus_common_ffi](https://pub.dev/packages/sqflite_plus_common_ffi)
...
To get started, you need to add `sqflite_plus` to your project. Follow the steps below:
...
* See [more information on opening a database](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/opening_db.md).
* Full [migration example](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/migration_example.md)
...
Basic information on SQL [here](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/sql.md).
...
More information on supported types [here](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/supported_types.md).
...
* [How to](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/how_to.md) guide
* [Notes about Desktop support](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/desktop_support.md)
* [Notes about Encryption support](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/encryption_support.md)
* [Notes about Web support](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/web_support.md)
* [Notes about SQLite versions](https://github.com/tekartik/sqflite/blob/master/sqflite_plus/doc/version.md) as some features may not be available depending on the SQLite version.
