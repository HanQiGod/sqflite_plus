...
Desktop support (Linux, Windows) is provided by the `sqflite_plus_common_ffi` package.
...
Not at this time. Some might prefer `sqflite_plus_common_ffi` over `sqflite`. The first
