...
import 'package:sqflite_plus_common_test/src/core_import.dart';
import 'package:sqflite_plus_common_test/src/sqflite_import.dart';
import 'package:sqflite_plus_common_test/src/test_scenario.dart';
...
void run(SqfliteTestContext? context) {
  ...
  group('protocol', () {
    ...
    test('open onCreate', () async {
      final scenario = wrapStartScenario(
        factory,
    ...
    test('recovered', () async {
      ...
      await scenario.factory.internalsInvokeMethod<Object?>('openDatabase', {
        'path': dbName,
        'singleInstance': true,
      });
    ...
    test('recovered_in_transaction_2', () async {
      ...
      await scenario.factory.internalsInvokeMethod<Object?>('execute', {
