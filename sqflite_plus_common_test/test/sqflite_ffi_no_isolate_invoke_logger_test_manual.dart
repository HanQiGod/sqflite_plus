...
import 'package:sqflite_plus_common_test/all_test.dart' as all;
...
var _factory = SqfliteDatabaseFactoryLogger(
  ...
  options: SqfliteLoggerOptions(type: SqfliteDatabaseFactoryLoggerType.invoke),
);
...
Future<void> main() async {
  ...
  await _factory.setDatabasesPath('${dbsPath}_invoke_logger_no_isolate');
