...
import 'package:sqflite_plus_common_ffi/src/sqflite_ffi_impl.dart';
import 'package:sqflite_plus_common_ffi/src/sqflite_import.dart';
...
class SqfliteFfiException extends SqfliteDatabaseException {
  ...
  String toString() {
    ...
    if (details != null) {
      if (details is Map) {
        var detailsMap = Map<String, Object?>.from(
          details!,
        ).cast<String, Object?>();
