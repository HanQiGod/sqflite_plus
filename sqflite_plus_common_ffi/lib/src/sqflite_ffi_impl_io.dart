...
import 'package:sqflite_plus_common/src/mixin/platform.dart'; // ignore: implementation_imports
...
class _SqfliteFfiHandlerIo with SqfliteFfiHandlerNonImplementedMixin {
  ...
  String getDatabasesPathPlatform() {
    return absolute(join('.dart_tool', 'sqflite_plus_common_ffi', 'databases'));
  }
