...
import 'package:sqflite_plus_common_ffi/src/windows/setup_impl.dart';
...
///
/// In debug mode: A bundled sqlite3.dll from the sqflite_plus_common_ffi package
/// is loaded.
///
...
/// Find sqflite_plus_common_ffi path from a repository path
///
...
/// to resolve the sqflite_plus_common_ffi package
...
String? findWindowsSqlite3DllPath() {
  ...
  /// Handles and dart script ran withing a project importing sqflite_plus_common_ffi
