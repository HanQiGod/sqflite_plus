...
In release mode,
add [sqlite3.dll](https://github.com/tekartik/sqflite/raw/master/sqflite_plus_common_ffi/lib/src/windows/sqlite3.dll) in same
...
your
application [work on Linux and windows](https://github.com/tekartik/sqflite/blob/master/sqflite_plus_common_ffi/doc/using_ffi_instead_of_sqflite.md).
