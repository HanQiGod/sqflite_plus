...
# Copy sqlite3.dll
cp ..\sqflite_plus_common_ffi\lib\src\windows\sqlite3.dll .\build\windows\runner\Release

# Run it
.\build\windows\runner\Release\sqflite_plus_test_app.exe
```
