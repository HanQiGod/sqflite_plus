...
Future<void> main() async {
  var binSubDir = 'sqflite_plus_test_app.app/Contents/MacOS';
  var binDir = join(platformExeDir, binSubDir);
  var exeDir = platformExeDir;
  var exePath = join(binDir, 'sqflite_plus_test_app');
  test(
    'build $platform',
    () async {
      ...
      await runAppShell.run(
        shellArgument(join(binSubDir, 'sqflite_plus_test_app')),
      );
    },
