...
import 'package:sqflite_plus_test_app/src/ffi_test_utils.dart';
...
Future<void> main() async {
  ...
  if (isSupported) {
    ...
    if (platformIsWindows) {
      ...
      await File(
        '../sqflite_plus_common_ffi/lib/src/windows/sqlite3.dll',
      ...
      var exePath = absolute(
        'build/linux/x64/release/bundle/sqflite_plus_test_app',
      );
      ...
      ).run('sqflite_plus_test_app.app/Contents/MacOS/sqflite_plus_test_app');
    }
  }
}
